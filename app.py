...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Quốc Huy - Trường TH Vĩnh Hảo - ĐT: 0972 740 773</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Quốc Huy - Trường TH Vĩnh Hảo - ĐT: 0972 740 773</div>", unsafe_allow_html=True)
